...
function addImage(src) {
	...
	{
		//最外层的span
		var upSpan = $('<span class="pic" id="a'+arr[3]+'" style="float:left;"></span>');
		//显示的图片
		var claname = '';
		if(focus_photo=='')
		{
		...
		var newImg = $('<img name="img_name"  width="80px" height="100px"  class=\''+claname+'\' onclick="focus_img(\''+arr[2]+'\',this);" style="margin: 5px; opacity:1" src=\''+arr[0]+'\'/>').appendTo(upSpan);
