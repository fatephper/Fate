...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data {
    ...
    public function fetch($template = null, $cache_id = null, $compile_id = null, $parent = null, $display = false, $merge_tpl_vars = true, $no_output_filter = false)
    {
        ...
        ? $template
        : $this->smarty->createTemplate($template, $cache_id, $compile_id, $parent, false); //index.html null null $this
        //dump($_template); smarty_internal_template 的对象
     ...
     * 显示模板
     *
     * @字符串型  $template   文件 或者文件对象句柄
     * @混合型    $cache_id   缓存id号
     * @混合型    $compile_id 编译文件id号
     * @对象      $parent     next higher level of Smarty variables
     */
