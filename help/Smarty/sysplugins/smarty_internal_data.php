...
class Smarty_Internal_Data {
    ...
    public $template_class = 'Smarty_Internal_Template'; //内部模板类

    public $tpl_vars = array();  //模板变量数组

    public $parent = null;       //待定

    public $config_vars = array(); //配置文件数组
     ...
     * @param boolean $scope the scope the variable will have  (local,parent or root) //变量作用域
     * @return Smarty_Internal_Data current Smarty_Internal_Data (or Smarty or Smarty_Internal_Template) instance for chaining 例链
     */
